...
export const CLAIM_WEEKLY_DISCRIMINATOR = new Uint8Array([
  122, 217, 42, 236, 16, 140, 62, 59,
]);

export function getClaimWeeklyDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    CLAIM_WEEKLY_DISCRIMINATOR,
  );
}

export type ClaimWeeklyInstruction<
...
export type ClaimWeeklyInstructionData = { discriminator: ReadonlyUint8Array };

export type ClaimWeeklyInstructionDataArgs = {};

export function getClaimWeeklyInstructionDataEncoder(): FixedSizeEncoder<ClaimWeeklyInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([["discriminator", fixEncoderSize(getBytesEncoder(), 8)]]),
    (value) => ({ ...value, discriminator: CLAIM_WEEKLY_DISCRIMINATOR }),
  );
}

export function getClaimWeeklyInstructionDataDecoder(): FixedSizeDecoder<ClaimWeeklyInstructionData> {
  return getStructDecoder([
    ["discriminator", fixDecoderSize(getBytesDecoder(), 8)],
  ]);
}

export function getClaimWeeklyInstructionDataCodec(): FixedSizeCodec<
  ClaimWeeklyInstructionDataArgs,
  ClaimWeeklyInstructionData
> {
  return combineCodec(
    getClaimWeeklyInstructionDataEncoder(),
    getClaimWeeklyInstructionDataDecoder(),
  );
}

export type ClaimWeeklyAsyncInput<
...
export async function getClaimWeeklyInstructionAsync<
  TAccountWinnerEntitlement extends string,
  TAccountUserProfile extends string,
  TAccountPayoutVault extends string,
  TAccountWinner extends string,
...
> {
  ...
  return Object.freeze({
    ...
    data: getClaimWeeklyInstructionDataEncoder().encode({}),
    programAddress,
  } as ClaimWeeklyInstruction<
    TProgramAddress,
    TAccountWinnerEntitlement,
    TAccountUserProfile,
    TAccountPayoutVault,
...
export function getClaimWeeklyInstruction<
  TAccountWinnerEntitlement extends string,
  TAccountUserProfile extends string,
  TAccountPayoutVault extends string,
  TAccountWinner extends string,
...
export type ParsedClaimWeeklyInstruction<
  TProgram extends string = typeof VOBLE_PROGRAM_ADDRESS,
...
> = {
  ...
  data: ClaimWeeklyInstructionData;
};

export function parseClaimWeeklyInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>,
): ParsedClaimWeeklyInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getClaimWeeklyInstructionDataDecoder().decode(instruction.data),
  };
}

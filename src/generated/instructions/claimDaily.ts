...
export const CLAIM_DAILY_DISCRIMINATOR = new Uint8Array([
  13, 226, 153, 154, 27, 168, 111, 103,
]);

export function getClaimDailyDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(CLAIM_DAILY_DISCRIMINATOR);
}

export type ClaimDailyInstruction<
...
export type ClaimDailyInstructionData = { discriminator: ReadonlyUint8Array };

export type ClaimDailyInstructionDataArgs = {};

export function getClaimDailyInstructionDataEncoder(): FixedSizeEncoder<ClaimDailyInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([["discriminator", fixEncoderSize(getBytesEncoder(), 8)]]),
    (value) => ({ ...value, discriminator: CLAIM_DAILY_DISCRIMINATOR }),
  );
}

export function getClaimDailyInstructionDataDecoder(): FixedSizeDecoder<ClaimDailyInstructionData> {
  return getStructDecoder([
    ["discriminator", fixDecoderSize(getBytesDecoder(), 8)],
  ]);
}

export function getClaimDailyInstructionDataCodec(): FixedSizeCodec<
  ClaimDailyInstructionDataArgs,
  ClaimDailyInstructionData
> {
  return combineCodec(
    getClaimDailyInstructionDataEncoder(),
    getClaimDailyInstructionDataDecoder(),
  );
}

export type ClaimDailyAsyncInput<
...
export async function getClaimDailyInstructionAsync<
  TAccountWinnerEntitlement extends string,
  TAccountUserProfile extends string,
  TAccountPayoutVault extends string,
  TAccountWinner extends string,
...
> {
  ...
  return Object.freeze({
    ...
    data: getClaimDailyInstructionDataEncoder().encode({}),
    programAddress,
  } as ClaimDailyInstruction<
    TProgramAddress,
    TAccountWinnerEntitlement,
    TAccountUserProfile,
    TAccountPayoutVault,
...
export function getClaimDailyInstruction<
  TAccountWinnerEntitlement extends string,
  TAccountUserProfile extends string,
  TAccountPayoutVault extends string,
  TAccountWinner extends string,
...
export type ParsedClaimDailyInstruction<
  TProgram extends string = typeof VOBLE_PROGRAM_ADDRESS,
...
> = {
  ...
  data: ClaimDailyInstructionData;
};

export function parseClaimDailyInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>,
): ParsedClaimDailyInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getClaimDailyInstructionDataDecoder().decode(instruction.data),
  };
}
